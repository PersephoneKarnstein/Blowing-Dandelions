...
async def getFollowers(self):
    ...
    while True:
        try:
            ...
            print(f"Grabbed {i} followers; list is now {len(all_followers)} followers long. Waiting for timeout...")
